	...
	function testIncrement()
	{
		$this
			...
			->then
				...
				->mock($client)->call('codeHasGeneratedMetrics')->withArguments(new metric\counting($bucket, 1))->once
			...
			->then
				...
				->mock($client)->call('codeHasGeneratedMetrics')->withArguments(new metric\counting($bucket, 1 + $count))->once
			...
			->then
				->object($this->testedInstance->increment($bucket))->isTestedInstance
				->mock($client)->call('codeHasGeneratedMetrics')->withArguments(new metric\counting($bucket, $start + 1))->once
